...
include::../templates/module_templates/module_mappings.adoc[]

// TODO: Include mapping YAML via:
// https://github.com/metanorma/stepmod-utils/issues/239


[[mim_express]]
=== MIM EXPRESS short listing
