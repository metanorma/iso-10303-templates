...
[yaml2text,changes_paths.yaml,paths]
------

{% liquid
assign path_prefix = "../../"
for path in paths
if path contains "mapping.changes.yaml"
assign mapping_path = path | prepend: path_prefix
elsif path contains "arm.changes.yaml"
assign arm_path = path | prepend: path_prefix
elsif path contains "mim.changes.yaml"
assign mim_path = path | prepend: path_prefix
endif
endfor
%}
